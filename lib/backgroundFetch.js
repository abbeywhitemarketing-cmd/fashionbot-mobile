...
export async function registerBackgroundFetch() {
  try {
    ...
    await BackgroundFetch.registerTaskAsync(TASK_NAME, {
      minimumInterval: 60 * 60 * 8, // at most every 8 hours (iOS decides actual timing)
...
// Called when the app moves to background — more reliable than waiting for iOS to schedule the task
